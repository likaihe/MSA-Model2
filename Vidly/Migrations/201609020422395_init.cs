                ...
                c => new
                    {
                        ...
                        Birthday = c.DateTime(),
                        IsSubscribedToLettler = c.Boolean(nullable: false),
                        MembershipeTypeId = c.Byte(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.MembershipTypes", t => t.MembershipeTypeId, cascadeDelete: true)
                .Index(t => t.MembershipeTypeId);
